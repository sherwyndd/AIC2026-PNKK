...
def build_parser():
    ...
    parser = argparse.ArgumentParser(description="Shot boundary detection (TransNetV2)")
    ...
    parser.add_argument("--force", action="store_true", help="Rerun shot_cut even if pipeline.log indicates completion")
...
def main():
    ...
    logger.info(f"Shot cut finished. Processed {result['processed_videos']} video(s).")
