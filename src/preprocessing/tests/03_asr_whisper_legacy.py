#!/usr/bin/env python3
"""Stage 3: ASR extraction with faster-whisper and keyframe-centered 6-second mapping."""
...
def build_parser():
    ...
    parser = argparse.ArgumentParser(description="ASR extraction for keyframe-based pipeline")
